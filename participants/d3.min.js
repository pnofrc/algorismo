(function() {
    ...
    function L(a, b) {
        ...
        arguments.length < 1 ? (a = 1,
        c = b / 4) : c = b / (2 * Math.PI) * Math.asin(1 / a),
        function(d) {
    ...
    function W(a, b, c) {
        ...
        return (i = Z[a]) ? b(i.r, i.g, i.b) : (a != null && a.charAt(0) === "#" && (a.length === 4 ? (d = a.charAt(1),
        d += d,
        e = a.charAt(2),
        e += e,
        f = a.charAt(3),
        f += f) : a.length === 7 && (d = a.substring(1, 3),
        e = a.substring(3, 5),
        f = a.substring(5, 7)),
        d = parseInt(d, 16),
        e = parseInt(e, 16),
    ...
    function X(a, b, c) {
        ...
        return f ? (h = i < .5 ? f / (e + d) : f / (2 - e - d),
        a == e ? g = (b - c) / f + (b < c ? 6 : 0) : b == e ? g = (c - a) / f + 2 : g = (a - b) / f + 4,
        g *= 60) : h = g = 0,
        _(g, h, i)
    }
    function Y(a) {
    ...
    function bm(a, b) {
        ...
        if (arguments.length < 2) {
            ...
            c.test(e.baseVal != null ? e.baseVal : e)
        }
    ...
    function bt(a, b, c) {
        ...
        a.tween = function(b, c) {
            return arguments.length < 2 ? d[b] : (c == null ? delete d[b] : d[b] = c,
            a)
        }
        ,
        a.ease = function(b) {
            return arguments.length ? (f = typeof b == "function" ? b : d3.ease.apply(d3, arguments),
            a) : f
        }
        ,
        a.each = function(b, c) {
            return arguments.length < 2 ? bB.call(a, b) : (e.on(b, c),
            a)
        }
        ,
        d3.timer(function(g) {
            return a.each(function(h, i, j) {
                ...
                function r() {
                    return --o.count || delete l.__transition__,
                    1
                }
                var k = []
                  , l = this
    ...
    function bw(a, b) {
        ...
        var c = Q(a);
        return typeof b == "function" ? d : b == null ? bv : (b += "",
        e)
    }
    function bB(a) {
    ...
    function bF() {
        var a, b = Date.now(), c = bC;
        while (c)
            a = b - c.then,
            a >= c.delay && (c.flush = c.callback(a)),
            c = c.next;
        var d = bG() - b;
        d > 24 ? (isFinite(d) && (clearTimeout(bE),
        bE = setTimeout(bF, d)),
        bD = 0) : (bD = 1,
        bH(bF))
    }
    function bG() {
        var a = null
          ...
          , c = Infinity;
        while (b)
            b.flush ? b = a ? a.next = b.next : bC = b.next : (c = Math.min(c, b.then + b.delay),
            b = (a = b).next);
        return c
    }
    function bI(a) {
    ...
    function b$(a, b) {
        ...
        ,
        d.domain = function(e) {
            return arguments.length ? (b = e[0] < 0 ? cb : ca,
            c = b.pow,
            a.domain(e.map(b)),
            d) : a.domain().map(c)
        }
        ,
        d.nice = function() {
            return a.domain(bQ(a.domain(), bR)),
            d
        }
        ,
        d.ticks = function() {
        ...
        d.tickFormat = function(a, e) {
            ...
            if (arguments.length < 1)
                return e;
            var f = a / d.ticks().length, g = b === cb ? (h = -1e-12,
            Math.floor) : (h = 1e-12,
            Math.ceil), h;
            return function(a) {
    ...
    function cc(a, b) {
        ...
        ,
        e.domain = function(b) {
            return arguments.length ? (a.domain(b.map(c)),
            e) : a.domain().map(d)
        }
        ,
        e.ticks = function(a) {
    ...
    function ce(a, b) {
        ...
        f.rangePoints = function(c, h) {
            ...
            var i = c[0]
              , j = c[1]
              , k = (j - i) / (a.length - 1 + h);
            return d = g(a.length < 2 ? (i + j) / 2 : i + k * h / 2, k),
            e = 0,
            b = {
                t: "rangePoints",
                x: c,
        ...
        f.rangeRoundBands = function(c, h) {
            ...
            return d = g(i + Math.round((j - i - (a.length - h) * k) / 2), k),
            e = Math.round(k * (1 - h)),
            b = {
                t: "rangeRoundBands",
                x: c,
    ...
    function cr(a) {
        ...
        g.interpolate = function(a) {
            return arguments.length ? (e = cv[d = a],
            g) : d
        }
        ,
    ...
    function cA(a, b) {
        return a.length < 3 ? cw(a) : a[0] + cC((a.push(a[0]),
        a), cD([a[a.length - 2]].concat(a, [a[1]]), b))
    }
    function cB(a, b, c) {
    ...
    function cC(a, b) {
        ...
        var c = a.length != b.length
          ...
          , h = g
          , i = 1;
        c && (d += "Q" + (f[0] - g[0] * 2 / 3) + "," + (f[1] - g[1] * 2 / 3) + "," + f[0] + "," + f[1],
        e = a[1],
        i = 2);
        if (b.length > 1) {
            h = b[1],
    ...
    function cO(a) {
        var b = 0
          ...
          , g = d[0] = cN(e, f);
        while (++b < c)
            d[b] = g + (g = cN(e = f, f = a[b + 1]));
        return d[b] = g,
        d
    }
    function cP(a) {
        var b = [], c, d, e, f, g = cO(a), h = -1, i = a.length - 1;
        while (++h < i)
            c = cN(a[h], a[h + 1]),
            Math.abs(c) < 1e-6 ? g[h] = g[h + 1] = 0 : (d = g[h] / c,
            e = g[h + 1] / c,
            f = d * d + e * e,
            f > 9 && (f = c * 3 / Math.sqrt(f),
            g[h] = f * d,
            g[h + 1] = f * e));
        h = -1;
        while (++h <= i)
    ...
    function cS(a) {
        ...
        var b = ct, c = ct, d = 0, e = cu, f, g, h, i = .7;
        return j.x = function(a) {
            return arguments.length ? (b = c = a,
            j) : c
        }
        ,
        j.x0 = function(a) {
        ...
        j.interpolate = function(a) {
            return arguments.length ? (g = cv[f = a],
            h = g.reverse || g,
            j) : f
        }
        ,
    ...
    function db(a, b) {
        ...
        return da ? (c.x = b.pageX,
        c.y = b.pageY) : (c.x = b.clientX,
        c.y = b.clientY),
    ...
    function dj(a, b, c) {
        e = [];
        if (c && b.length > 1) {
            var d = bO(a.domain()), e, f = -1, g = b.length, h = (b[1] - b[0]) / ++c, i, j;
            while (++f < g)
                for (i = c; --i > 0; )
                    (j = +b[f] - i * h) >= d[0] && e.push(j);
            for (--f,
            i = 0; ++i < c && (j = +b[f] + i * h) < d[1]; )
                e.push(j)
        }
        return e
    }
    ...
    function dx() {
        d3.event.keyCode == 32 && dm && !dr && (dt = null,
        du[0] -= dq[1][0],
        du[1] -= dq[1][1],
        dr = 2,
        O())
    ...
    function dy() {
        d3.event.keyCode == 32 && dr == 2 && (du[0] += dq[1][0],
        du[1] += dq[1][1],
        dr = 0,
        O())
    }
    function dz() {
        if (du) {
            var a = d3.svg.mouse(dm)
              , b = d3.select(dm);
            dr || (d3.event.altKey ? (dt || (dt = [(dq[0][0] + dq[1][0]) / 2, (dq[0][1] + dq[1][1]) / 2]),
            du[0] = dq[+(a[0] < dt[0])][0],
            du[1] = dq[+(a[1] < dt[1])][1]) : dt = null),
            dn && (dA(a, dn, 0),
            dv(b, dq)),
            dp && (dA(a, dp, 1),
            dw(b, dq)),
    ...
    function dA(a, b, c) {
        var d = bP(b), e = d[0], f = d[1], g = du[c], h = dq[1][c] - dq[0][c], i, j;
        dr && (e -= g,
        f -= h + g),
        i = Math.max(e, Math.min(f, a[c])),
        dr ? j = (i += g) + h : (dt && (g = Math.max(e, Math.min(f, 2 * dt[c] - i))),
        g < i ? (j = i,
        i = g) : j = g),
        dq[0][c] = i,
        dq[1][c] = j
    ...
    function dB() {
        du && (dz(),
        d3.select(dm).selectAll(".resize").style("pointer-events", dk.empty() ? "none" : "all"),
        dl("brushend"),
    ...
    function dN() {
        ...
        dK("dragend"),
        dJ && (O(),
        dJ = d3.event.target === dE),
        dD = dE = dF = dG = dH = dI = null
    }
    function dO() {
        dJ && (O(),
        dJ = 0)
    ...
    function eb() {
        var a = d3.svg.touches(dY), b = -1, c = a.length, d;
        while (++b < c)
            dS[(d = a[b]).identifier] = d_(d);
        return a
    }
    function ec() {
    ...
    function ed() {
        dR = null,
        dQ && (d$ = 1,
        eg(dU[2], d3.svg.mouse(dY), dQ))
    }
    function ee() {
        dQ && (d$ && (O(),
        d$ = dX === d3.event.target),
        dU = dV = dW = dX = dY = dZ = dQ = null)
    }
    function ef() {
        d$ && (O(),
        d$ = 0)
    ...
    d3.split = function(a, b) {
        ...
        while (++f < g)
            b.call(d, e = a[f], f) ? d = [] : (d.length || c.push(d),
            d.push(e));
        return c
    }
    ,
    ...
    d3.xhr = function(a, b, c) {
        ...
        arguments.length < 3 ? (c = b,
        b = null) : b && d.overrideMimeType && d.overrideMimeType(b),
        d.open("GET", a, !0),
    ...
    var s = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/
      ...
      , x = ["y", "z", "a", "f", "p", "n", "Î¼", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(y);
    ...
    d3.interpolateString = function(a, b) {
        ...
        while (d < j)
            k = i.pop(),
            h[k.i + 1] == null ? h[k.i] = k.x : (h[k.i] = k.x + h[k.i + 1],
            h.splice(k.i + 1, 1)),
            j--;
    ...
    d3.interpolateTransform = function(a, b) {
        ...
        return h[0] != i[0] || h[1] != i[1] ? (c.push("translate(", null, ",", null, ")"),
        d.push({
            i: 1,
        ...
        n[0] != o[0] || n[1] != o[1] ? (e = c.push(c.pop() + "scale(", null, ",", null, ")"),
        d.push({
            i: e - 4,
    ...
    d3.interpolateObject = function(a, b) {
        var c = {}, d = {}, e;
        for (e in a)
            e in b ? c[e] = Q(e)(a[e], b[e]) : d[e] = a[e];
        for (e in b)
            e in a || (d[e] = b[e]);
        return function(a) {
            for (e in c)
    ...
    U.prototype.brighter = function(a) {
        ...
        var b = this.r
          ...
          , d = this.b
          , e = 30;
        return !b && !c && !d ? T(e, e, e) : (b && b < e && (b = e),
        c && c < e && (c = e),
        d && d < e && (d = e),
        T(Math.min(255, Math.floor(b / a)), Math.min(255, Math.floor(c / a)), Math.min(255, Math.floor(d / a))))
    }
    ,
    ...
    ba.prototype.brighter = function(a) {
        return a = Math.pow(.7, arguments.length ? a : 1),
        _(this.h, this.s, this.l / a)
    }
    ,
    ba.prototype.darker = function(a) {
        return a = Math.pow(.7, arguments.length ? a : 1),
        _(this.h, this.s, a * this.l)
    }
    ,
    ...
    bi.select = function(a) {
        ...
        for (var g = -1, h = this.length; ++g < h; ) {
            ...
            for (var i = -1, j = e.length; ++i < j; )
                (f = e[i]) ? (c.push(d = a.call(f, f.__data__, i)),
                d && "__data__"in f && (d.__data__ = f.__data__)) : c.push(null)
        }
        return bc(b)
    }
    ,
    ...
    bi.style = function(a, b, c) {
        ...
        arguments.length < 2 ? window.getComputedStyle(this.node(), null).getPropertyValue(a) : this.each(b == null ? d : typeof b == "function" ? f : e)
    }
    ,
    ...
    bi.on = function(a, b, c) {
        ...
        var d = "__on" + a
          , e = a.indexOf(".");
        return e > 0 && (a = a.substring(0, e)),
        arguments.length < 2 ? (e = this.node()[d]) && e._ : this.each(function(e, f) {
            function h(a) {
                var c = d3.event;
                d3.event = a;
                try {
    ...
    ,
    bi.call = function(a) {
        return a.apply(this, (arguments[0] = this,
        arguments)),
        this
    }
    ,
    ...
    bs.select = function(a) {
        ...
        for (var h = -1, i = this.length; ++h < i; ) {
            ...
            for (var j = -1, k = f.length; ++j < k; )
                (g = f[j]) ? (c.push(e[j] = d = a.call(f.parentNode, g.__data__, j)),
                d.__data__ = g.__data__) : c.push(null)
        }
        return bc(b)
    }
    ;
    ...
    bx.select = function(a) {
        ...
        for (var f = -1, g = this.length; ++f < g; ) {
            b.push(c = []);
            for (var h = this[f], i = -1, j = h.length; ++i < j; )
                (e = h[i]) && (d = a.call(e.node, e.node.__data__, i)) ? ("__data__"in e.node && (d.__data__ = e.node.__data__),
                c.push({
                    node: d,
                    delay: e.delay,
                    duration: e.duration
    ...
    bx.attrTween = function(a, b) {
        function d(a, d) {
            ...
            return e === bu ? (this.removeAttribute(c),
            null) : e && function(a) {
        ...
        function e(a, d) {
            ...
            return e === bu ? (this.removeAttributeNS(c.space, c.local),
            null) : e && function(a) {
    ...
    bx.styleTween = function(a, b, c) {
        ...
        this.tween("style." + a, function(d, e) {
            ...
            return f === bu ? (this.style.removeProperty(a),
            null) : f && function(b) {
    ...
    d3.svg.arc = function() {
        ...
        return e.innerRadius = function(b) {
            return arguments.length ? (a = d3.functor(b),
            e) : a
        }
        ,
        e.outerRadius = function(a) {
            return arguments.length ? (b = d3.functor(a),
            e) : b
        }
        ,
        e.startAngle = function(a) {
            return arguments.length ? (c = d3.functor(a),
            e) : c
        }
        ,
        e.endAngle = function(a) {
            return arguments.length ? (d = d3.functor(a),
            e) : d
        }
        ,
        e.centroid = function() {
    ...
    d3.svg.chord = function() {
        ...
        f.endAngle = function(a) {
            return arguments.length ? (e = d3.functor(a),
            f) : e
        }
        ,
        f
    ...
    d3.svg.touches = function(a, b) {
        return arguments.length < 2 && (b = d3.event.touches),
        b ? d(b).map(function(b) {
            var c = db(a, b);
    ...
    d3.svg.axis = function() {
        function j(j) {
            j.each(function(k, l, m) {
                ...
                : Object, p = a.ticks ? a.ticks.apply(a, g) : a.domain(), q = h == null ? a.tickFormat ? a.tickFormat.apply(a, g) : String : h, r = dj(a, p, i), s = n.selectAll(".minor").data(r, String), t = s.enter().insert("line", "g").attr("class", "tick minor").style("opacity", 1e-6), u = o(s.exit()).style("opacity", 1e-6).remove(), v = o(s).style("opacity", 1), w = n.selectAll("g").data(p, String), x = w.enter().insert("g", "path").style("opacity", 1e-6), y = o(w.exit()).style("opacity", 1e-6).remove(), z = o(w).style("opacity", 1), A, B = bP(a), C = n.selectAll(".domain").data([0]), D = C.enter().append("path").attr("class", "domain"), E = o(C), F = a.copy(), G = this.__chart__ || F;
                this.__chart__ = F,
                ...
                case "bottom":
                    ...
                    z.select("text").attr("x", 0).attr("y", Math.max(c, 0) + f).attr("dy", ".71em").attr("text-anchor", "middle"),
                ...
                case "top":
                    ...
                    x.select("text").attr("y", -(Math.max(c, 0) + f)),
                    z.select("line").attr("x2", 0).attr("y2", -c),
                    z.select("text").attr("x", 0).attr("y", -(Math.max(c, 0) + f)).attr("dy", "0em").attr("text-anchor", "middle"),
                    E.attr("d", "M" + B[0] + "," + -e + "V0H" + B[1] + "V" + -e);
                    break;
                case "left":
                    A = di,
                    ...
                    z.select("text").attr("x", -(Math.max(c, 0) + f)).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "end"),
                ...
                case "right":
                    ...
                    x.select("text").attr("x", Math.max(c, 0) + f),
                    z.select("line").attr("x2", c).attr("y2", 0),
                    z.select("text").attr("x", Math.max(c, 0) + f).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "start"),
                    E.attr("d", "M" + e + "," + B[0] + "H0V" + B[1] + "H" + e)
                }
                if (a.ticks)
                    x.call(A, G),
        ...
        ,
        j.ticks = function() {
            return arguments.length ? (g = arguments,
            j) : g
        }
        ,
    ...
    d3.svg.brush = function() {
        function e(a) {
            ...
            a.each(function() {
                var a = d3.select(this).on("mousedown.brush", f), h = a.selectAll(".background").data([0]), i = a.selectAll(".extent").data([0]), j = a.selectAll(".resize").data(g, String), k;
                h.enter().append("rect").attr("class", "background").style("visibility", "hidden").style("pointer-events", "all").style("cursor", "crosshair"),
                i.enter().append("rect").attr("class", "extent").style("cursor", "move"),
                j.enter().append("rect").attr("class", function(a) {
                    return "resize " + a
        ...
        function f() {
            ...
            dq = d,
            du = d3.svg.mouse(dm),
            (dr = a.classed("extent")) ? (du[0] = d[0][0] - du[0],
            du[1] = d[0][1] - du[1]) : a.classed("resize") ? (ds = d3.event.target.__data__,
            du[0] = d[+/w$/.test(ds)][0],
            du[1] = d[+/^n/.test(ds)][1]) : d3.event.altKey && (dt = du.slice()),
            dn = !/^(n|s)$/.test(ds) && b,
            dp = !/^(e|w)$/.test(ds) && c,
            dl = g(this, arguments),
            dl("brushstart"),
        ...
        e.extent = function(a) {
            var f, g, h, i, j;
            return arguments.length ? (b && (f = a[0],
            g = a[1],
            c && (f = f[0],
            g = g[0]),
            b.invert && (f = b(f),
            ...
            c && (h = d[0][1],
            i = d[1][1],
            c.invert && (h = c.invert(h),
            i = c.invert(i)),
            i < h && (j = h,
            h = i,
            i = j)),
            b && c ? [[f, h], [g, i]] : b ? [f, g] : c && [h, i])
        }
        ,
        e.clear = function() {
            return d[0][0] = d[0][1] = d[1][0] = d[1][1] = 0,
            e
        }
        ,
        e.empty = function() {
        ...
        ,
        d3.select(window).on("mousemove.brush", dz).on("mouseup.brush", dB).on("keydown.brush", dx).on("keyup.brush", dy),
        d3.rebind(e, a, "on")
    }
    ;
    ...
    d3.behavior.drag = function() {
        function c() {
            ...
            d3.select(window).on("mousemove.drag", dM).on("touchmove.drag", dM).on("mouseup.drag", dN, !0).on("touchend.drag", dN, !0).on("click.drag", dO, !0)
        }
        function d() {
            dD = a,
            dE = d3.event.target,
    ...
    d3.behavior.zoom = function() {
        function d() {
            this.on("mousedown.zoom", f).on("mousewheel.zoom", g).on("DOMMouseScroll.zoom", g).on("dblclick.zoom", h).on("touchstart.zoom", i),
            d3.select(window).on("mousemove.zoom", ed).on("mouseup.zoom", ee).on("touchmove.zoom", ec).on("touchend.zoom", eb).on("click.zoom", ef, !0)
        }
        function e() {
            dU = a,
            dV = c,
        ...
        return d.extent = function(a) {
            return arguments.length ? (c = a == null ? eh : a,
            d) : c
        }
        ,
        d3.rebind(d, b, "on")
    ...
    ;
    var dP, dQ, dR, dS = {}, dT = 0, dU, dV, dW, dX, dY, dZ, d$, eh = [[-Infinity, Infinity], [-Infinity, Infinity], [-Infinity, Infinity]]
}
)();
